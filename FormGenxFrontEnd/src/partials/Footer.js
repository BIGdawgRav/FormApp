...
function Footer() {
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6" align="center">

        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-13 gap-8 py-8 md:py-12 border-t border-gray-200">

          {/* 1st block */}
          <div className="sm:col-span-12 lg:col-span-3" align="center">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          {/* <div className="text-sm text-gray-600 mr-4">Made by <a className="text-blue-600 hover:underline" href="https://cruip.com/">Raveen Senanayake</a>. All rights reserved.</div> */}
